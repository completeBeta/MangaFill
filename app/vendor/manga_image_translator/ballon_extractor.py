...
#
# ============================================================================
# VENDORED FILE — DO NOT EDIT IN PLACE. Upstream copy, byte-for-byte.
#   Upstream : https://github.com/zyddnys/manga-image-translator
#   Path     : manga_translator/rendering/ballon_extractor.py
#   Commit   : 95227a2bb0fd306cd4f0c104d57284026f991b3a  (2026-07-20)
#   SHA256 of the body below (everything after this header):
#              640841edd503c903f6448e4a3fcc634a7550299e9df36d234cd46ee134ae1d4f
#   Licence  : GNU GPL v3.0 — see /LICENSES/GPL-3.0.txt
#   Copyright: the manga-image-translator contributors
#
# Manga Fill is distributed under the GNU AGPL v3.0. AGPL-3.0 section 13 permits
# combining that work with GPL-3.0 code; THIS file remains governed by GPL-3.0.
# See /THIRD_PARTY.md for the full attribution and how to obtain upstream source.
# ============================================================================
import cv2
